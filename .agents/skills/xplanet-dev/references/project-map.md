...
| `xplanet-agent` | 8000 (internal) | Python/LangGraph bounded planner-decision-tool loop, safe fetch, Claim-Evidence-Critic review, one supplemental search, checkpoints, and evaluation |
